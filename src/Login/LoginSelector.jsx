...
// // Creating the context to pass user data
...
//         <Container fluid className="text-center py-5 features-section">
//           <h2>Our Features</h2>
//           <div className="d-flex justify-content-around flex-wrap">
//             <Card className="m-2 p-3 feature-card">
...
//         <Container fluid className="text-center py-5 testimonials-section">
//           <h2>What Our Users Say</h2>
//           <div className="d-flex justify-content-around flex-wrap">
//             <Card className="m-2 p-3 testimonial-card">
//               <Card.Text>
...
// export default LoginSelector;  //Login Module
    ...
    return (
      <div className={`login-selector ${showLogin ? "blurred" : ""}`}>
        ...
        <Container
          ...
          style={{ backgroundColor: "#f0f8ff", color: "#333" }} // Light blue
        >
          <h1>Welcome to Your Personal Diet Tracker</h1>
          <p>
            Track your meals, monitor your diet, and achieve your health goals.
